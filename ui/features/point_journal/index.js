...
import PointJournalIndex from './react/index'
import ready from '@instructure/ready'

ready(() => {
  const pointJournalContainer = document.getElementById('point_journal_container')

  ReactDOM.render(<PointJournalIndex />, pointJournalContainer)
})
