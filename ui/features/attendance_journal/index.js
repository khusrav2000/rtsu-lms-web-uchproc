...
import AttendanceJournalIndex from './react/index'

ready(() => {
  const attendanceJournalContainer = document.getElementById('attendance_journal_container')

  ReactDOM.render(<AttendanceJournalIndex />, attendanceJournalContainer)
})
